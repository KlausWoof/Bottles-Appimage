...
bottles_deps="cabextract dconf freetype2 fvs2 gamemode icoextract imagemagick libpulse libunwind mesa patool pipewire procps-ng vkbasalt xterm"
...
BINSAVED="fvs2 python ibus xdpyinfo"
SHARESAVED="alsa"
LIBSAVED="python gio/ Gio GLib GModule GObject Gtk Adw Xdp Gsk Graphene Gdk IBus ibus cairo PangoCairo Pango HarfBuzz freetype2 freetype2 librsvg gdk-pixbuf soup ntdll libunwind libvulkan libmp3lame libFLAC libvorbis"
